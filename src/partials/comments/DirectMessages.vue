<template>
  <div class="mt-4">
    <div class="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase mb-3">Комментарии к публикациям</div>
    <ul class="mb-6">
      <li
          class="-mx-2"
...
const {activeCommentsAccount, setActiveCommentsChat, activeCommentsChat} = await useMessangers()

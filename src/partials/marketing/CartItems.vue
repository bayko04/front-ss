<template>
  <ul>
    <!-- Cart item -->
    <router-link to="/marketing/triggerTemplate" custom v-slot="{ navigate, isExactActive }">
      <li @click="navigate" class="sm:flex items-center py-6 border-b border-slate-200 dark:border-slate-700 cursor-pointer">

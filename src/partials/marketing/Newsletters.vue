          ...
          <div class="grow">
            <div class="p-6 space-y-6">
              <div class="flex justify-between items-center">
                <div class="">
                  <h2
                    class="text-2xl text-gray-800 dark:text-gray-100 font-bold"
                  >
                    Список рассылок
                  </h2>
                </div>
              ...
              <table
                class="min-w-full bg-white dark:bg-gray-800 border-spacing-[10px]"
                v-if="newsletterStore.newsletters"
              >
                <thead>
                  <tr class="">
                    <th

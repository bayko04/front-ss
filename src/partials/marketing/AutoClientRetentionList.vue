        ...
        <div class="flex flex-col md:flex-row md:-mr-px">
          <div class="grow">
            ...
            <div class="p-6 space-y-6" v-if="marketingStore.reminderSettings">
              ...
              <!-- Toggle Switch -->
              <div
                class="flex flex-wrap items-center -m-3 justify-between gap-[10px] max-xl:justify-start max-lg:flex-col max-lg:items-start"
              >
                <div class="w-40">
                  <div class="flex items-center">
                    <label class="inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        v-model="
                          marketingStore.reminderSettings.auto_client_retention
                            .active
                        "
                        class="sr-only peer"
                      />

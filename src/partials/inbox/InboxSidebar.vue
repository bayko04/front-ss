      ...
      <div>
        ...
        <div class="px-5 py-4">
          ...
          <form class="relative">
            ...
            <input id="inbox-search" class="form-input w-full pl-9 bg-white dark:bg-slate-800" type="search" placeholder="Search…" />
          ...
          <div class="relative mt-4">
            ...
            <ul class="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
              ...
              <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                <a class="block pb-3 text-slate-500 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 whitespace-nowrap" href="#0">Promotions</a>
              </li>
            </ul>
          </div>
          <!-- Inbox -->
          <div class="mt-4">
            ...
            <ul class="mb-6">
                ...
                <button class="flex w-full p-2 rounded bg-indigo-100 dark:bg-indigo-500/30 text-left" @click.stop="$emit('close-inboxsidebar')">
                  ...
                  <div class="grow truncate">
                    <div class="flex items-center justify-between mb-1.5">
                      <div class="truncate">
                        <span class="text-sm font-semibold text-slate-800 dark:text-slate-100">Dominik Lamakani</span>
                      </div>
                      <div class="text-xs text-slate-500 font-medium">4 Aug</div>
                    </div>
                    <div class="text-xs font-medium text-slate-800 dark:text-slate-100 truncate mb-0.5">Chill your mind with this amazing offer 🎉</div>
                    <div class="text-xs whitespace-normal">Lorem ipsum dolor sit amet, consecte adipiscing elit aute irure dolor…</div>
                  </div>
                </button>
              </li>
              <li class="-mx-2">
                <button class="flex w-full p-2 rounded text-left" @click.stop="$emit('close-inboxsidebar')">
                  <img class="w-8 h-8 rounded-full mr-2" src="../../images/user-32-05.jpg" width="32" height="32" alt="User 05" />
                  <div class="grow truncate">
                    <div class="flex items-center justify-between mb-1.5">
                      <div class="truncate">
                        <span class="text-sm font-semibold text-slate-800 dark:text-slate-100">Simona Lürwer</span>
                      </div>
                      <div class="text-xs text-slate-500 font-medium">4 Aug</div>
                    </div>
                    <div class="text-xs font-medium text-slate-800 dark:text-slate-100 truncate mb-0.5">🙌 Help us improve Mosaic by giving…</div>
                    <div class="text-xs whitespace-normal">Lorem ipsum dolor sit amet, consecte adipiscing elit aute irure dolor…</div>
                  </div>
                </button>
              </li>
              <li class="-mx-2">
                <button class="flex w-full p-2 rounded text-left" @click.stop="$emit('close-inboxsidebar')">
                  <img class="w-8 h-8 rounded-full mr-2" src="../../images/user-32-06.jpg" width="32" height="32" alt="User 05" />
                  <div class="grow truncate">
                    <div class="flex items-center justify-between mb-1.5">
                      <div class="truncate">
                        <span class="text-sm font-semibold text-slate-800 dark:text-slate-100">Mary Roszczewski</span>
                      </div>
                      <div class="text-xs text-slate-500 font-medium">1 Aug</div>
                    </div>
                    <div class="text-xs font-medium text-slate-800 dark:text-slate-100 truncate mb-0.5">[Urgent] Changes to links for public…</div>
                    <div class="text-xs whitespace-normal">👋 Lorem ipsum dolor sit amet, consecte adipiscing elit aute irure dolor…</div>
                  </div>
                </button>
              </li>
              <li class="-mx-2">
                <button class="flex w-full p-2 rounded text-left" @click.stop="$emit('close-inboxsidebar')">
                  <img class="w-8 h-8 rounded-full mr-2" src="../../images/user-32-04.jpg" width="32" height="32" alt="User 05" />
                  <div class="grow truncate">
                    <div class="flex items-center justify-between mb-1.5">
                      <div class="truncate">
                        <span class="text-sm font-semibold text-slate-800 dark:text-slate-100">Adrian Przetocki</span>
                      </div>
                      <div class="text-xs text-slate-500 font-medium">1 Aug</div>
                    </div>
                    <div class="text-xs font-medium text-slate-800 dark:text-slate-100 truncate mb-0.5">🙌 Help us improve Mosaic by giving…</div>
              ...
              <li class="-mx-2">
                <button class="flex w-full p-2 rounded text-left" @click.stop="$emit('close-inboxsidebar')">
                  <img class="w-8 h-8 rounded-full mr-2" src="../../images/user-32-02.jpg" width="32" height="32" alt="User 05" />
                  <div class="grow truncate">
                    <div class="flex items-center justify-between mb-1.5">
                      <div class="truncate">
                        <span class="text-sm font-semibold text-slate-800 dark:text-slate-100">Tisha Yanchev</span>
                      </div>
                      <div class="text-xs text-slate-500 font-medium">1 Aug</div>
                    </div>
                    <div class="text-xs font-medium text-slate-800 dark:text-slate-100 truncate mb-0.5">Re: Here’s an extra 25% OFF 🎉</div>

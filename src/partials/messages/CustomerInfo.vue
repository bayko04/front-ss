<template>
  <div>
    <div>
      <div class="lg:sticky lg:top-16 bg-slate-50 dark:bg-gradient-to-b dark:from-slate-800 dark:to-slate-900 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-slate-700 lg:w-[390px] lg:h-[calc(100dvh-64px)]">
        <div class="py-8 px-4 lg:px-8">
          <div class="max-w-sm mx-auto lg:max-w-none">

            <div class="text-slate-800 dark:text-slate-100 font-semibold text-center mb-6">Physical Metal Card Summary</div>
                ...
                <svg class="w-full h-full" width="326" height="190" viewBox="0 0 326 190" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g fill="none" fill-rule="evenodd">
                    <g stroke="#FFF">
                      ...
                      <path d="m95.001 48.454 61.614-34.273" style="mix-blend-mode:overlay" filter="url(#ccill-b)" transform="translate(23.168 10.2)" />
                      <path d="m102.738 59.711 90.966-49.333" filter="url(#ccill-c)" transform="translate(23.168 10.2)" />
                      <path d="M132.402 56.164c51.89-27.442 9.677-6.22 133.867-46.582" style="mix-blend-mode:overlay" filter="url(#ccill-d)" transform="translate(23.168 10.2)" />
                      ...
                      <path d="M78.484 90.425 188.905 57.9" style="mix-blend-mode:overlay" filter="url(#ccill-g)" transform="translate(23.168 10.2)" />
                      ...
                      <path d="M177.385 128.372c38.41-17.811 13.059-6.784 77.387-29.83" style="mix-blend-mode:overlay" filter="url(#ccill-m)" transform="translate(23.168 10.2)" />
                      ...
                      <path d="M29.686 21.19 70.172 3.645" style="mix-blend-mode:overlay" filter="url(#ccill-p)" transform="translate(23.168 10.2)" />
                      <path d="M17.977 79.61 73.04 55.091" filter="url(#ccill-q)" transform="translate(23.168 10.2)" />
                    </g>
                    <path fill-opacity=".24" fill="#FFF" style="mix-blend-mode:overlay" filter="url(#ccill-r)" d="M156 .573 331.59 311H75L20 .573z" transform="translate(0 -40)" />
                  </g>
                </svg>
              </div>
            ...
            <!-- Details -->
            <div class="mt-6">
              <div class="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-1">Details</div>
              <ul>
                <li class="flex items-center justify-between py-3 border-b border-slate-200 dark:border-slate-700">
                  ...
                  <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">Physical Metal Card</div>
                </li>
                <li class="flex items-center justify-between py-3 border-b border-slate-200 dark:border-slate-700">
                  <div class="text-sm">Status</div>
                  <div class="flex items-center whitespace-nowrap">
                    <div class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></div>
                    <div class="text-sm font-medium text-slate-800 dark:text-slate-100">Active</div>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <!-- Payment Limits -->
            <div class="mt-6">
              <div class="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-4">Payment Limits</div>
              <div class="pb-4 border-b border-slate-200 dark:border-slate-700">
                <div class="flex justify-between text-sm mb-2">
                  <div>Spent This Month</div>
                  <div class="italic">$750,00 <span class="text-slate-400 dark:text-slate-500">/</span> $1,500.00</div>
                </div>
                <div class="relative w-full h-2 bg-slate-300 dark:bg-slate-700">
            ...
            <!-- Withdrawal Limits -->
            <div class="mt-6">
              <div class="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-4">Withdrawal Limits</div>
              <div class="pb-4 border-b border-slate-200 dark:border-slate-700">
                <div class="flex justify-between text-sm mb-2">
                  <div>Withdrawn This Month</div>
                  <div class="italic">$100,00 <span class="text-slate-400 dark:text-slate-500">/</span> $1,500.00</div>
                </div>
                <div class="relative w-full h-2 bg-slate-300 dark:bg-slate-700">

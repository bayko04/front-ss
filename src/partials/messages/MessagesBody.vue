  ...
  <div class="grow px-4 sm:px-6 md:px-5 py-6">
    ...
    >
      ...
      <div v-if="renderDivider(message.created_at)" class="flex justify-center">
        <div
          class="inline-flex items-center justify-center text-xs text-slate-600 font-medium px-2.5 py-1 bg-white border border-slate-200 rounded-full my-5"
        >
      ...
      <div
        v-else-if="message.message_status_id !== 7"

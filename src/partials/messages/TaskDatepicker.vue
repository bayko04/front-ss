<template>
  <div class="relative">
    <flat-pickr class="form-input pl-9 dark:bg-slate-800 text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-200 font-medium w-full" :config="config" v-model="date"></flat-pickr>

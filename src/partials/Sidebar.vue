<template>
  <div class="min-w-fit z-60" >
    ...
    <div
      id="sidebar"
      ref="sidebar"
      class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh]  w-20 lg:w-20 lg:sidebar-expanded:!w-20 2xl:!w-20 shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out"
        ...
        <div>
          <ul class="mt-3">
            ...
            <router-link to="/customers" custom v-slot="{ href, navigate, isExactActive }">
              <li v-tooltip="'Клиенты'" class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                <a class="block text-slate-200 transition duration-150" :class="isExactActive ? 'hover:text-slate-200' : 'hover:text-white'" :href="href" @click="navigate">
                  <div class="flex items-center justify-between">
                    <div class="grow flex items-center">
                      <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
            ...
            <router-link to="/marketingSettings/auto-client-retention" custom v-slot="{ href, navigate, isExactActive }">
                  ...
                  <div class="flex items-center justify-between">
                    <div class="grow flex items-center">
                      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                           xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 290.626 290.626" xml:space="preserve"
                           fill="#000000">
                            ...
                            <g>
                              <g>
                                <path class="fill-current" :class="isExactActive ? 'text-indigo-500' : 'text-slate-600'"
                                      d="M267.722,9.375h18.216V0h-18.75L144.797,28.125H44.274C19.861,28.125,0,47.986,0,72.399v61.453 c0,24.413,19.861,44.273,44.274,44.273h7.289v97.594c0,8.217,6.689,14.906,14.906,14.906h21.755 c8.217,0,14.906-6.684,14.906-14.906v-60.094h16.809c6.234,0,11.311-5.077,11.311-11.316c0-2.977-1.209-5.892-3.314-8.002 l-5.489-5.489c-0.366-0.366-0.572-0.867-0.572-1.378v-11.316h22.908l121.355,28.008l19.8,0.117v-9.375h-18.216L150,169.711V36.539 L267.722,9.375z M44.274,168.75c-19.242,0-34.898-15.656-34.898-34.898V72.399c0-19.242,15.656-34.898,34.898-34.898h96.352 v131.25h-37.5H51.563h-7.289V168.75z M93.75,275.719c0,3.047-2.48,5.531-5.531,5.531h-21.75c-3.047,0-5.531-2.48-5.531-5.531 v-97.594H93.75V275.719z M115.814,197.442l5.489,5.489c0.366,0.366,0.572,0.867,0.572,1.378c0,1.069-0.872,1.941-1.941,1.941 h-16.809v-28.125h9.375v11.316C112.5,192.417,113.71,195.333,115.814,197.442z"></path>
                                <path class="fill-current" :class="isExactActive ? 'text-indigo-300' : 'text-slate-400'"
                                      d="M107.813,112.5c0-2.766-0.83-5.33-2.217-7.509l9.675-16.12c0.633,0.084,1.261,0.192,1.917,0.192 c7.753,0,14.063-6.309,14.063-14.063s-6.309-14.063-14.063-14.063S103.125,67.247,103.125,75c0,3.698,1.463,7.041,3.802,9.553 l-8.794,14.658c-1.388-0.464-2.841-0.773-4.383-0.773c-3.783,0-7.205,1.519-9.736,3.956L74.4,97.585 c0.352-1.228,0.6-2.498,0.6-3.834c0-7.753-6.309-14.063-14.063-14.063S46.875,85.997,46.875,93.75c0,2.648,0.778,5.1,2.058,7.214 L37.538,118.06c-1.486-0.53-3.061-0.872-4.725-0.872c-7.753,0-14.063,6.309-14.063,14.062s6.309,14.063,14.063,14.063 s14.063-6.309,14.063-14.063c0-2.648-0.778-5.1-2.058-7.214l11.395-17.095c1.486,0.53,3.061,0.872,4.725,0.872 c2.958,0,5.7-0.928,7.964-2.494l10.955,5.48c-0.066,0.563-0.169,1.12-0.169,1.702c0,7.753,6.309,14.063,14.063,14.063 S107.813,120.253,107.813,112.5z M117.188,70.313c2.588,0,4.688,2.105,4.688,4.688s-2.1,4.688-4.688,4.688 c-2.588,0-4.688-2.105-4.688-4.688S114.6,70.313,117.188,70.313z M32.813,135.938c-2.588,0-4.688-2.105-4.688-4.688 c0-2.583,2.1-4.687,4.688-4.687s4.688,2.105,4.688,4.687C37.5,133.833,35.4,135.938,32.813,135.938z M56.25,93.75 c0-2.583,2.1-4.688,4.688-4.688s4.688,2.105,4.688,4.688s-2.1,4.688-4.688,4.688S56.25,96.333,56.25,93.75z M93.75,117.188 c-2.588,0-4.688-2.105-4.688-4.688s2.1-4.688,4.688-4.688c2.588,0,4.688,2.105,4.688,4.688S96.338,117.188,93.75,117.188z"></path>
                                <rect class="fill-current" :class="isExactActive ? 'text-indigo-500' : 'text-slate-600'" x="267.188" y="0"
                                      width="23.438" height="206.25"></rect>
                              </g>
                            </g>
                          </g>
                      </svg>
              ...
              <router-link to="/calendar" custom v-slot="{ href, navigate, isExactActive }">
                  <li v-tooltip="'Календарь'" class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                      <a class="block text-slate-200 transition duration-150" :class="isExactActive ? 'hover:text-slate-200' : 'hover:text-white'" :href="href" @click="navigate">
              ...
              <router-link to="/products" custom v-slot="{ href, navigate, isExactActive }">
                  <li v-tooltip="'Продукты'" class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                      <a class="block text-slate-200 transition duration-150" :class="isExactActive ? 'hover:text-slate-200' : 'hover:text-white'" :href="href" @click="navigate">
                          <div class="flex items-center justify-between">
                              <div class="grow flex items-center">
                                  <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <router-link to="/" custom v-slot="{ href, navigate, isExactActive }">
                  <li v-tooltip="'Аналитика'" class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                      <a class="block text-slate-200 transition duration-150" :class="isExactActive ? 'hover:text-slate-200' : 'hover:text-white'" :href="href" @click="navigate">
                          <div class="flex items-center justify-between">
                              <div class="grow flex items-center">
                                  <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <li v-tooltip="'Транзакции'" class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                <div class="flex items-center justify-between">
                  <a class="block text-gray-800 dark:text-gray-100 truncate transition" :class="currentRoute.fullPath.includes('finance') ? '' : 'hover:text-gray-900 dark:hover:text-white'" :href="href" @click="navigate">
                    <div class="flex items-center justify-between">
                      <div class="flex items-center">
                        <svg class="shrink-0 fill-current" :class="currentRoute.fullPath.includes('finance') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">

<template>
  <div class="grow">
    ...
    <div class="p-6 space-y-6">
      ...
      <!-- General -->
      <section>
        <h3 class="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mb-1">Основные</h3>
        <ul>
          <li class="flex justify-between items-center py-3 border-b border-slate-200 dark:border-slate-700">
            <!-- Left -->
            <div>
              <div class="text-slate-800 dark:text-slate-100 font-semibold">Новые чаты в мессенджерах</div>
              <div class="text-sm">Уведомляет о каждом новом клиенте который пишет в любой из подключенных мессенджеров.</div>
            </div>
            <!-- Right -->
          ...
          <li class="flex justify-between items-center py-3 border-b border-slate-200 dark:border-slate-700">
            <!-- Left -->
            <div>
              <div class="text-slate-800 dark:text-slate-100 font-semibold">Новый залоговый билет</div>
              <div class="text-sm">Уведомляет при создании нового залогового билета.</div>
            </div>
            <!-- Right -->
            <div class="flex items-center ml-4">

                ...
                <div class="grid gap-5 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <Field v-model="email" id="email" name="email" class="form-input w-full" type="text" />
                    </div>
                  ...
                  <div>
                    ...
                    <div>
                      <div class="flex items-center justify-between">
                        ...
                        <Tooltip class="ml-2" bg="dark" size="md">
                          <div class="text-sm text-slate-200">Пароль от личного кабинета. Этот пароль необходимо передать пользователью, и предупредить чтобы его поменяли.</div>
                        </Tooltip>
                      </div>
...
const schema = Yup.object().shape({
  ...
  last_name: Yup.string().required('Фамилия пользователья обязательно').min(2, 'Должно быть не менее 2 символов').max(256, 'Должно быть не более 256 символов'),
  middle_name: Yup.string(),
  inn: Yup.string(),
  passport: Yup.string(),
  citizenship_id: Yup.string(),
  sex: Yup.string(),
  role: Yup.string().required('Роль пользователья обязательно'),

        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-4">
            ...
            >
              <!-- Create event button -->
              <button
                @click.stop="newTaskModal()"
                class="btn bg-indigo-500 rounded-[5px] text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white"
              >
                Добавить задачу
              </button>
            </div>
          ...
          >
            ...
            <div class="grid grid-cols-7 gap-px bg-slate-200 dark:bg-slate-700">
              ...
              <div
                class="relative bg-white dark:bg-slate-800 h-auto sm:min-h-28 lg:min-h-36 overflow-hidden"
              ...
              >
                <div class="h-full flex flex-col justify-between">
                  ...
                  <div class="flex justify-between items-center p-0.5 sm:p-1.5">
                    ...
                    >
                      <span class="hidden md:inline" @click="setDetailsDay(day)"
                        >детали</span
                      >
                    </button>
                    <!-- Day number -->
                    <button
                      @click="setDetailsDay(day)"
...
const nextMonth = () => {
  ...
  getDays();
  taskStore.getTasksForUser(
    authStore.userData.user.id,
    month.value + 1,
    year.value
  );
};

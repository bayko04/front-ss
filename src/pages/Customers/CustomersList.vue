        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
              <h1 class="test text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Клиенты ✨</h1>
            </div>
          ...
          <!-- Pagination -->
          <div class="mt-8">
            <PaginationNumeric :paginateData="customerStore.customers" :paginateAction="customerStore.customersPaginate"/>
          </div>

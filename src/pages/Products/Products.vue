    ...
    >
      ...
      <main class="grow">
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            >
              ...
              <label
                ...
                for="file_input"
                >Импорт <span v-if="file"> ({{ file.name }})</span></label
              >
              <input
              ...
              <!-- Add customer button -->
              <button
                @click.stop="productStore.productModalStatus = 'add'"
                class="btn bg-indigo-500 hover:bg-indigo-600 text-white"
              >
                <svg
          ...
          <div class="mt-8">
            <PaginationNumeric
              :paginateData="productStore.products"
              :paginateAction="productStore.productsPaginate"
            />
          </div>

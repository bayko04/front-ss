                ...
                <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                    ...
                    <div class="sm:flex sm:justify-between sm:items-center mb-8">
                        ...
                        <div class="mb-4 sm:mb-0">
                            <h1 class="test text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Дополнительная выдача по залоговому билету ✨</h1>
                        </div>
                    ...
                    <div class="border-t border-slate-200 dark:border-slate-700">
                        <Form @submit="onSubmit" :validation-schema="schema" v-slot="{ errors, isSubmitting }">
                            ...
                            <div class="space-y-8 mt-8">
                                ...
                                <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Погашение процентов и штрафов</h2>
                                <div>
                                ...
                                <router-link to="/" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                                    ...
                                    <span class="h idden xs:block ml-2">Добавить запись</span>
                                </router-link>

                                <br>
                                <div class="mt-2">
                                    <!-- Start -->
                                    <button type="submit" class="btn bg-green-500 hover:bg-green-600 text-white">Погасить задолженность</button>
                                    <!-- End -->
                                </div>
                                <!---------------->
                                <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Выдача дополнительного займа</h2>
                                ...
                                <div>
                                    <div class="grid gap-5 md:grid-cols-4">
                                        ...
                                        <div>
                                            <!-- Start -->
                                            <div>
                                                <label class="block text-sm font-medium mb-1" for="searchByName">Сумма выдачи<span class="text-rose-500">*</span></label>
                                                <Field v-model="searchByName" id="searchByName" name="searchByName" class="form-input w-full" type="number" />
                                            </div>
                                            <!-- End -->
                                        </div>
                            ...
                            <div class="mt-2">
                                <!-- Start -->
                                <button type="submit" class="btn bg-green-500 hover:bg-green-600 text-white">Выдать дополнительный займ</button>
                                <!-- End -->
                            </div>
                        </Form>
                    </div>

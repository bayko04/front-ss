<template>
  <div class="relative inline-flex w-full h-[42px]" v-if="options">
    <button
      ref="trigger"
      class="btn h-full w-full justify-between min-w-44 bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-200"
